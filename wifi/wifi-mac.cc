...
WifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::WifiMac")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
    .AddAttribute ("AtimAckTimeout", "When this timeout expires, the ATIM/ATIMACK handshake has failed.", //Joao
                   TimeValue (GetDefaultCtsAckTimeout ()),
                   MakeTimeAccessor (&WifiMac::SetAtimAckTimeout,
                                     &WifiMac::GetAtimAckTimeout),
                   MakeTimeChecker ())
...
WifiMac::Configure80211a (void)
{
  ...
  SetAtimAckTimeout (MicroSeconds (16 + 44 + 9 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2)); //Joao
...
void
WifiMac::Configure80211b (void) //Joao
{
  NS_LOG_FUNCTION (this);
  ...
  SetAtimAckTimeout (MicroSeconds (10 + 304 + 20 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2)); //Joao
...
WifiMac::Configure80211_10Mhz (void)
{
  ...
  SetAtimAckTimeout (MicroSeconds (32 + 88 + 13 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2)); //Joao
...
WifiMac::Configure80211_5Mhz (void)
{
  ...
  SetAtimAckTimeout (MicroSeconds (64 + 176 + 21 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2)); //Joao
