...
public:
  ...
  /**
   * \param atimAckTimeout the duration of a ATIMACK timeout.
   */
  void SetAtimAckTimeout (Time atimAckTimeout); //Joao
  /**
  ...
  /**
   * \return the current ATIMACK timeout duration.
   */
...
private:
  ...
  bool m_isAtimWindow;  //If it is ATIM-Window
};
