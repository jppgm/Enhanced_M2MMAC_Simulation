...
void
MacLowTransmissionParameters::EnableAtim (void) //Joao
{
  m_sendAtim = true;
}

void
MacLowTransmissionParameters::DisableAtim (void) //Joao
{
  m_sendAtim = false;
}
...
bool
MacLowTransmissionParameters::MustSendAtim (void) const
{
  return m_sendAtim;
}
