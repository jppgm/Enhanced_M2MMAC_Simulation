...
public:
  ...
  */
   ...
   *
   * \param m_isAtimWindow the maximum SSRC
   */
  void SetIsAtimWindow (bool m_isAtimWindow);
  /**
   ...
   */
  virtual void SetNumberOfTxAntennas (uint32_t tx); //Joao
  /**
   * \return the number of transmitting antenna on this device
   */
  virtual uint32_t GetNumberOfTxAntennas (void) const; //Joao
  /**
  * \param rx the number of receivers on this node.
  */
  virtual void SetNumberOfRxAntennas (uint32_t rx); //Joao
  /**
   * \return the number of receivers on this node.
   */
  virtual uint32_t GetNumberOfRxAntennas (void) const; //Joao
  /**
   * \set the number of links on this node
   */
  virtual void SetNumberOfCommunicationLink (uint32_t link); //Joao
  /**
   * \return the number of links on this node.
   */
  virtual uint32_t GetNumberOfCommunicationLink (void) const; //Joao
  uint8_t GetChannelCode (void) const; //Joao
  bool GetChannelLock (void) const; //Joao
  void SetChannelLock (bool channellock); //Joao
  void SetChannelCode (uint8_t channelcode); 
  /**
...
private:
  ...
  uint32_t m_numberOfTxAntennas;     //!< Number of transmitting antennas Joao
  uint32_t m_numberOfRxAntennas;        //!< Number of receiving antennas Joao
  ...
  uint32_t m_numberOfLinks;            //!< Number of links Joao
  uint8_t m_channelCode;            //!< Number of the channel used for this node
  bool m_channelLock;            //!< If the channel is reserved
