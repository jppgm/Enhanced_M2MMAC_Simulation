...
public:
  ...
  /**
   * Notify that AtimAck timer has started for the given duration.
   *
   * \param duration
   */
  void NotifyAtimAckTimeoutStartNow (Time duration); //Joao
  /**
   * Notify that AtimAck timer has reset.
   */
...
private:
   ...
   * \return the most recent time
   */
  Time MostRecent (Time a, Time b, Time c, Time d, Time e, Time f, Time g, Time h) const; //Joao
  /**
  ...
  Time m_lastAtimAckTimeoutEnd; //!< the last AtimACK timeout end time Joao
