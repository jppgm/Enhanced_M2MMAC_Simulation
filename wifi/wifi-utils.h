...
uint32_t GetBlockAckSize (BlockAckType type);
  /**
   * Return the total ATIM size (including FCS trailer).
   *
   * \return the total ATIM size
   */
  uint32_t GetAtimSize (void); //Joao
/**
...
uint32_t GetRtsSize (void);
  /**
   * Return the total ATIMACK size (including FCS trailer).
   *
   * \return the total ATIMACK size
   */
  uint32_t GetAtimAckSize (void); //Joao
/**
