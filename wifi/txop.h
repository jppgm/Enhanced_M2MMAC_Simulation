...
public:
  ...
  /* Event handlers */
  /**
   * Event handler when a AtimAck timeout has occurred.
   */
  virtual bool MissedAtimAck (void); //Joao
  /* Event handlers */
  /**
  ...
  /**
   * Event handler when an AtimACK is received.
   */
  virtual void GotAtimAck (void); //Joao
  /**
   * Remove ATIM Packet from the Mac Queue
   */
  virtual void RemoveAtim (WifiMacHeader hdr); //Joao
  /**
   * Cancel the Atim Retransmission
   */
  virtual void CancelRetransmission(void); //Joao
  /**
...
protected:
  ...
  /**
   * Check ATIM should be re-transmitted if ATIMACK was missed.
   *
   * \param packet current packet being transmitted.
   * \param hdr current header being transmitted.
   * \return true if ATIM should be re-transmitted,
   *         false otherwise.
   */
  bool NeedAtimRetransmission (Ptr<const Packet> packet, const WifiMacHeader &hdr); //Joao
  /**
