...
public:
  ...
  void EnableMultiTidBlockAck (void);
    /**
   * Send a ATIM, and wait ATIMACKTimeout for a ATIMACK. If we get a
   * ATIMACK on time, call MacLowTransmissionListener::GotAtimAck
   * do nothing. Otherwise, call MacLowTransmissionListener::MissedAtimAck
   * and do not send data.
   */
  void EnableAtim (void); //Joao
  /**
  ...
  /**
   * Do not send ATIM and wait for ATIMACK before sending data.
  */
  void DisableAtim (void); //Joao
  /**
  ...
  /**
   * \returns true if ATIM should be sent and ATIMACK waited for before
   *          sending data, false otherwise.
   */
  bool MustSendAtim (void) const; //Joao
  /**
